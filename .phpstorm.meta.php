...
'register','login','password.request','password.reset','verification.notice',
'verification.verify','password.confirm','storage.local',);
...
'livewire.pages.auth.login','livewire.pages.auth.register','livewire.pages.auth.reset-password','livewire.pages.auth.verify-email','livewire.posts.index',
'livewire.profile.delete-user-form','livewire.profile.update-password-form','livewire.profile.update-profile-information-form','livewire.welcome.navigation','profile',
'volt-livewire::layout.navigation','volt-livewire::pages.auth.confirm-password','volt-livewire::pages.auth.forgot-password','volt-livewire::pages.auth.login','volt-livewire::pages.auth.register',
'volt-livewire::pages.auth.reset-password','volt-livewire::pages.auth.verify-email','volt-livewire::posts.index','volt-livewire::profile.delete-user-form','volt-livewire::profile.update-password-form',
'volt-livewire::profile.update-profile-information-form','volt-livewire::welcome.navigation','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
